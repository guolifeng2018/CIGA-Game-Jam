...
public static class EditorCoroutineRunner
{
    private class EditorCoroutine : IEnumerator
    {
        ...
        public bool MoveNext()
        {
            ...
            else { if (this.executionStack.Count > 1) { this.executionStack.Pop(); return true; } }
            return false;
        }
        public void Reset() { throw new System.NotSupportedException("This Operation Is Not Supported."); }
        public object Current { get { return this.executionStack.Peek().Current; } }
    ...
    public static IEnumerator StartEditorCoroutine(IEnumerator iterator)
    {
        ...
        if (buffer == null) { buffer = new List<IEnumerator>(); }
